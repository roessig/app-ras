...
class RoadmapGenerator:
    ...
    def buildNewRoadmap(self, req):
        ...
        rospy.logfatal("resolution " + str(self.resolution))
...
# On startup the node publishes one RoadmapGraph message, which is used by TrafficPlanner,
# TrafficMonitor and PathPlanner.
